...
export const games: Game[] = [
  {
    ...
    summary:
      'A Warhammer 40k Space Invaders clone built in GoDot that attempts to emulate the looks and feel of a classic GameBoy game. Fend off waves of White Scar Marines and survive as long as you can, racking up a high score.<br>This is game 3 of the 20 games challenge, and was written over the course about 7 days total. A lot was learned during this project, with the primary focus being making my own 2d sprite art within aseprite for the first time.',
