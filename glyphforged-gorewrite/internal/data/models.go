...
var Projects = []Project{
	{
		...
		WasmDemos: []WasmDemo{
			{ID: "randomwalker", Title: "Random Walker", Src: "/public/projectbins/noc-ch-0/randomwalker/random_walker.html", Summary: "A random walker is like a drunk pixel stumbling around a grid. At every step it moves one unit in a random direction, producing unpredictable-yet often surprisingly coherent-paths over time. Written in Rust with macroquad.", Aspect: "3/2", Width: 600, SourceCode: "https://emgithub.com/iframe.html?target=https%3A%2F%2Fgithub.com%2FGlyphForged%2FLearnRust%2Fblob%2Ftrunk%2Fnature_of_code%2Fchapter0%2Frandom_walker%2Fsrc%2Fmain.rs&style=base16%2Fgruvbox-dark-hard&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on&maxHeight=500"},
			{ID: "noisewalker", Title: "Perlin Noise walker", Src: "/public/projectbins/noc-ch-0/noisewalker/noise_walker.html", Summary: "This variant replaces pure randomness with Perlin noise. Instead of following a random unit vector, the walker's x and y coordinates come directly from a noise field, yielding smoother, more organic motion. Written in Rust with macroquad.", Aspect: "3/2", Width: 600, SourceCode: "https://emgithub.com/iframe.html?target=https%3A%2F%2Fgithub.com%2FGlyphForged%2FLearnRust%2Fblob%2Ftrunk%2Fnature_of_code%2Fchapter0%2Fnoise_walker%2Fsrc%2Fmain.rs&style=base16%2Fgruvbox-dark-hard&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on&maxHeight=500"},
	...
	},
	{
		...
		WasmDemos: []WasmDemo{
			{ID: "shader_demo", Title: "Macroquad Shader Demo", Src: "/public/projectbins/shaders/shader_demo/shader_demo.html", Summary: "This example is a simple fractal shader using lessons learned from shadertoy creators and Inigo Quilez, utilizing SDFs and oscillation to produce a fun effect.", Aspect: "3/2", Width: 640, SourceCode: "https://emgithub.com/iframe.html?target=https%3A%2F%2Fgithub.com%2FGlyphForged%2Fmq_shader_template%2Fblob%2Ftrunk%2Fsrc%2Fmain.rs&style=base16%2Fgruvbox-dark-hard&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on&maxHeight=500"},
		},
	},
}
